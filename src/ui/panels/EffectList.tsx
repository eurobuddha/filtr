        ...
        return (
          <button
            ...
            className={`flex w-full items-center gap-2 px-3 py-1 text-left text-[12px] transition-colors ${
              on ? 'bg-surface-2 text-accent-ink' : 'text-fg-dim hover:bg-surface hover:text-fg'
            }`}
          >
            <span className={`text-[8px] leading-none ${on ? 'text-accent-ink' : 'text-transparent'}`}>●</span>
